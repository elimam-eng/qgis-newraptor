...
from PointXY import QgsGeometry
...
class NewRaptor:
    ...
    def run(self):
        ...
        if result:
            ...
            lyrNests = QgsProject.instance().mapLayersByName("Raptor Nests")
            lyrBuffer = QgsProject.instance().mapLayersByName("Raptor Buffer")
            
            if len(lyrNestsList) > 0 and len(lyrBufferList) > 0:
                lyrNests = lyrNestsList[0]
                lyrBuffer = lyrBufferList[0]
            else:
                QMessageBox.critical(self.dlg, "Error", "Required layers not found in the project")
            return
            ...
            QMessageBox.information(self.dlg, "Message", "New Nest ID: {}\n\nLatitude: {}\nLongitude: {}\nSpecies: {}\nBuffer: {}\nStatus: {}\nLast Survey: {}".format(valNestID, valLat, valLng, valSpecies, valBuffer, valStatus, valStatus, valLast))
            
            
            # Create a new feature for the nest
